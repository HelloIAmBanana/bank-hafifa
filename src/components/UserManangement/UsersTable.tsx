...
import { Grid, Box, Container, Typography, Skeleton, Button, Menu, MenuItem, TextField } from "@mui/material";
...
import { capitalizeFirstLetter, formatIsoStringToDate, getUserFullName } from "../../utils/utils";
...
const UsersTable: React.FC = () => {
    ...
    () => [
        ...
        cellRenderer: (params: any): JSX.Element => {
          return (
            <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
              <Typography fontFamily={"Poppins"}>{params.data.id}</Typography>
            </div>
          );
        },
      },
          ...
          return (
            <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
              <Typography fontFamily={"Poppins"}>
                {capitalizeFirstLetter(params.data.firstName)}
              </Typography>
            </div>
          );
        },
      },
      {
        ...
        cellRenderer: (params: any): JSX.Element => {
          return (
            <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
              <Typography fontFamily={"Poppins"}>
                {capitalizeFirstLetter(params.data.lastName)}
              </Typography>
            </div>
          );
        },
      },
      {
        ...
        cellRenderer: (params: any): JSX.Element => {
          return (
            <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
              <Typography fontFamily={"Poppins"}>{params.data.email}</Typography>
            </div>
          );
        },
      },
      ...
      },
      {
        ...
        cellRenderer: (params: any): JSX.Element => {
          return (
            <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
              <Typography fontFamily={"Poppins"}>{params.data.gender}</Typography>
            </div>
          );
        },
      },
        ...
        cellRenderer: (params: any): JSX.Element => {
          return (
            <div onContextMenu={handleContextMenu}>
              <Typography fontFamily={"Poppins"}>{params.data.balance.toLocaleString()}$</Typography>
            </div>
          );
        },
      },
      {
        ...
        cellRenderer: (params: any): JSX.Element => {
          return (
            <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
              <Typography fontFamily={"Poppins"}>{capitalizeFirstLetter(params.data.role)}</Typography>
            </div>
          );
        },
      },
  ...
  const onCellMouseOver = (params: any) => {
    const hoveredUser: User = params.data;
    setHoveredUser(hoveredUser); // 0
  };

  const deleteUser = async (user: User) => {
    //await CRUDLocalStorage.deleteItemFromList<User>("users",user)
    const usersAmount = contextMenu ? 1 : selectedRows.length;
    usersAmount > 1
      ? successAlert(`${usersAmount} users were DELETED`)
      : successAlert(`${getUserFullName(user)} was DELETED!`);
  };
                ...
                <Grid container mt={2}>
                  ...
                  <div onContextMenu={handleContextMenu} style={{ cursor: "context-menu" }}>
                    ...
                    >
                      ...
                      <MenuItem onClick={() => deleteUser(hoveredUser!)}>
